...
if 0:
    f=open('antibody_pretrain/sequence_pretrain/output_8_large_sample.txt','r')
    lines=f.readlines()
    f.close()
...
if 1:
    ...
    loss=get_loss_resume(['antibody_pretrain/sequence_pretrain/output_8_large_sample.txt',
                          'antibody_pretrain/sequence_pretrain/output_8_large_sample_re.txt',
                          'antibody_pretrain/sequence_pretrain/output_8_large_sample_re2.txt'],smooth,step)
    plt.figure()
    plt.plot(loss)
    plt.ylim(0.75,1.15)
    plt.savefig('loss_step{}.png'.format(step))
