...
RENUMBER=False
batch_size=1
file_to_predict='antibody_data/structure_data/light/seq_split/sequences_{}.npy'.format(file_id)


tp_fasta_file='temp/temp_light_{}.fasta'.format(file_id)
...
for i in tqdm(range(0,sequence_all,batch_size)):
    pdb_file='antibody_data/structure_data/light/split_predict/{}/output_{}_{}.pdb'.format(file_id, 
                                                                                                           file_id, 
                                                                                                           i//batch_size)
    #pdb_file='/code/lxd/igfold/output/tp_{}.pdb'.format(i)
